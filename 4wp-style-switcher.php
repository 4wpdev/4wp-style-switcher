...
define( 'FORWP_STYLE_SWITCHER_VERSION', '0.2.1' );

define(
	'FORWP_STYLE_SWITCHER_PLAYGROUND_URL',
	'https://playground.wordpress.net/?blueprint-url=https://raw.githubusercontent.com/4wpdev/4wp-style-switcher/v0.2.1/.wordpress-org/assets/blueprints/blueprint.json'
);
